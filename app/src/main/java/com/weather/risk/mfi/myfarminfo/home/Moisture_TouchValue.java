...
public class Moisture_TouchValue extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    title = (TextView) findViewById(R.id.aaaaa);
    title.setText("Moisture Value");
  ...
  private void getMapContour(String idd, String date) {
    final ProgressDialog dialoug = ProgressDialog.show(this, "",
            "Fetching Data\nPlease wait...", true);
    StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://www.myfarminfo.com/yfirest.svc/Clients/GetFarmData/" + idd + "/soil/" + date,
