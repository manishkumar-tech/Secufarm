 ...
 */
public class MotorPieFrag  extends Fragment implements SeekBar.OnSeekBarChangeListener,
    ...
    public MotorPieFrag(String on, String off) {
    ...
    private void setData(int count, float range) {
        ...
        in1 = Float.parseFloat(m_on);
        in2 = Float.parseFloat(m_off);
        ...
        Log.v("e_on_pie",m_on+"--"+in1);
        Log.v("e_off_pie",m_off+"--"+in2);
    ...
    private SpannableString generateCenterSpannableText() {
       ...
       /* if (averageValue.equalsIgnoreCase("-")) {
        ...
        int total = Integer.parseInt(m_on)+ Integer.parseInt(m_off);
