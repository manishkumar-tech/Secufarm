 ...
 */
public class NDVIAdapter extends RecyclerView.Adapter<NDVIAdapter.ViewHolder> {
...
// you provide access to all the views for a data item in a view holder
    ...
    public NDVIAdapter(Context con, ArrayList<NDBI_Bean> myDataset) {
        mDataset = myDataset;
        mContext = con;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (sss!=null && sss.equalsIgnoreCase("9999999")){
            holder.ndviValue.setText("Clouded");
        }else {
