...
//                Process.THREAD_PRIORITY_BACKGROUND);
    ...
    public void setTaskPerformance() {
...
//                new Utility.getFarmerDeatials(object, db, context).execute();
                ...
                try {
                    ...
                    try {
                        ...
                        if (seconds > 3) {
                            SaveLocalFile(db, BackgroundUploadService.this, SN_NewHomeScreen, ScreenTracking_URL, response, "", "" + seconds, "", "Working");
                        }
                        ...
                        try {
                            ...
                            ex.printStackTrace();
                            SaveLocalFile(db, BackgroundUploadService.this, SN_NewHomeScreen, ScreenTracking_URL, response, "JSON Response Error", "" + seconds, "", "Error");
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
//                        Toast.makeText(BackgroundUploadService.this, getResources().getString(R.string.ResponseFormattingError), Toast.LENGTH_LONG).show();
                        SaveLocalFile(db, BackgroundUploadService.this, SN_NewHomeScreen, ScreenTracking_URL, response, "JSON Response Error", "" + seconds, "", "Error");
                    }
